...
https://sites.google.com/view/robobuasbuyov1
...
#define sensorOppoLow 1// sensor jenis FS80NK Jenis detect opponent nilai rendah
...
const int tracerOnly = 0; // tukar jadi 1 untuk lawan tanpa langgar, hanya follow, 0 untuk langgar
